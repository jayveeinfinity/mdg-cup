                ...
                <div class="team-section-inner inner">
                    ...
                    <div class="row">
                        <div class="col-12 mb-5">
                            ...
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addPlayerModal" data-bs-target="#staticBackdrop"><i class="fas fa-plus"></i> Add player</button>
                        </div>
                        @foreach($team->players()->get() as $player)
                        <div class="col-xl-3 col-md-4 col-sm-6">
                            <div class="team-wraper">
                                <div class="player-card">
                                    <a class="image" href="{{ route('team.player.show', ['id' => $player->id]) }}">
                                        @if($player->image)
                                            <img src="{{ $player->image->filepath }}" alt="" height="234px">
                                        @else
                                            <img src="storage/images/players/default.png" alt="" height="234px">
                                        @endif
                                    </a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <input type="hidden" id="team_id" value="{{ $team->id }}" readonly>
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-lg" type="text" name="name" id="name" placeholder="Type name..." required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-lg" type="number" name="age" id="age" placeholder="Type age..." required>
                            </div>
                            <div class="mb-3">
                                <label for="jersey_number">Jersey Number:</label>
                                <input class="form-control form-control-lg" type="number" name="jersey_number" id="jersey_number" placeholder="Type jersey number..." min="0" max="99" oninput="validity.valid||(value='');" required/>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    addPlayerBtn.addEventListener('click', function(e) {
        ...
        formData.append('team_id', teamInput.value);
        formData.append('player_name', nameInput.value);
        formData.append('position', positionSelect.options[positionSelect.selectedIndex].value);
        formData.append('age', ageInput.value);
        formData.append('jersey_number', jerseyNumberInput.value);
        ...
        $.ajax({
            ...
            processData: false,
            beforeSend: () => {
                // exportAccessLogBtn.disabled = true;
            },
            success: (response) => {
                console.log(response);
                // if(JSON.parse(response).status === "success") {
                //     window.open(JSON.parse(response).path, '_blank').focus();
                // }
                // exportAccessLogBtn.disabled = false;
                // Swal.fire({
                ...
                // }).then((result) => {
                //     setTimeout(HideModal, 1000, JSON.parse(response).status, JSON.parse(response).data);
                // });
            }
        });
    });
